...
export function AlertsFeed() {
  ...
  const sourceAlerts = useGridStore((state) => state.alerts);
  const fetchAlerts = useGridStore((state) => state.fetchAlerts);
  ...
  const alerts: Alert[] = sourceAlerts.slice(0, 4).map((alert) => ({
    id: alert.id,
