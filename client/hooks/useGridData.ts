...
import { api, ForecastData, GridAlert, GridMetrics, DashboardStats, WeatherSnapshot } from '../services/api';
...
export const useGridStore = create<GridState>((set) => ({
  ...
  fetchDashboard: async (city = "Mumbai") => {
    ...
    try {
      ...
      const message = e instanceof Error ? e.message : 'Failed to fetch dashboard';
